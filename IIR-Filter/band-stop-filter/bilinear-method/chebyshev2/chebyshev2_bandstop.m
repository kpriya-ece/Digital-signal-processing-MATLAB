...
Fp = [1500 2500]; Fs = [1800 2200]; ap = 2.5; as = 45;    
wp=2*Fsamp*tan(pi*Fp/Fsamp);
ws=2*Fsamp*tan(pi*Fs/Fsamp);

[N, wn] = buttord(wp, ws, ap, as,"s");
[bs1,as1] = butter(N,wn,"stop","s");
...
[N2, wn1] = cheb2ord(wp, ws, ap, as,"s");
[bs3,as3] = cheby2(N2,as,wn1,"stop","s");
[bz3,az3] = bilinear(bs3,as3,Fsamp);
...
sgtitle('CHEBYSHEV TYPE 2 BAND STOP FILTER (BILINEAR METHOD)');
saveas(gcf, 'chebyshev2_bandstop.png');  
