...
[bs2,as2] = cheby2(N2,as,wn2,"low","s");
...
y2 = filter(bz2,az2, x);
y_fft2=fft(y2,fft_ord);  % fixed: was y instead of y2
...
sgtitle('CHEBYSHEV TYPE 2 LOW PASS FILTER (BILINEAR METHOD)');
saveas(gcf, 'chebyshev2_filter.png');
